...
src/
  objects/             # THE GAME-OBJECT HIERARCHY: actors, dressing, foliage — all
    ...
    actors/            # ACTOR class. Actor.tsx is THE BASE — everything every actor
      ...
      xl-element/      #   the descriptor + `export const XxxActor = createActor(Xxx
      xxl-element/     #   Descriptor)` (props at the mount site are overrides). EVERY
      apartment/       #   actor's `component` is ModelActor (or Building) — no actor owns
                       ...
                       #   ModelActor, model, spawn attrs }). Static props (big-beeble,
                       #   xl/xxl-element, apartment) have no spec: a plain descriptor.
