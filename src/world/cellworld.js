...
export const cellworld = (function () {
    ...
    class Cellworld {
        ...
        GetBlock(x, y) {
            ...
            points.sort((a, b) => {
                var distanceA = currentVertex.distanceTo(
                    new THREE.Vector3(a.x, a.y, 0)
                );
                var distanceB = currentVertex.distanceTo(
            ...
            var blockType =
                blocks[
                    Math.floor(new Math.seedrandom(closest)() * blocks.length)
                ];
