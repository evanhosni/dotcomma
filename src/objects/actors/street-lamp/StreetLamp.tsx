...
// ---- Lamp lighting ----
// ALL lamp light comes from the lamp-grid data texture (lighting/lampGlow.ts):
...
/** Domain-space lamp-head glow sources of every mounted lamp — written by
 ...
 * see lighting/lampGlow.ts. Opacity is tied directly to camera distance
