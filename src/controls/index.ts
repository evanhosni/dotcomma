...
import { PointerLockControls } from './tempPointLock'
...
export const controls = (function () {
  ...
  return {
    FPSControls: class {
      ...
      private _move: { [key: string]: boolean } = {
          forward: false,
          backward: false,
          left: false,
          right: false,
      ...
      private _standing: boolean = true;
      private _velocity: THREE.Vector3 = new THREE.Vector3(0, 0, 0);
      private _decceleration: THREE.Vector3 = new THREE.Vector3(-10, -10, -10);
      private _acceleration: THREE.Vector3 = new THREE.Vector3(2500, 10000, 2500);
      private _sprinting: boolean = false;
      private _controls: PointerLockControls;

      constructor(params: { cells: any; camera: THREE.Camera; scene: THREE.Scene }) {
        this._cells = params.cells;
        this._Init(params);
      }

      private _Init(params: { camera: THREE.Camera; scene: THREE.Scene }) {
        this._radius = 2;
        this._enabled = false;
        this._move = {
          forward: false,
      ...
      private _SetupPointerLock() {
        ...
        if (hasPointerLock) {
          ...
          const lockError = (event: any/* TODO: i made this of type any */) => {
            console.log(event);
          };
          ...
          document.getElementById('[dotcomma]')!.addEventListener('click', (event) => {
            ...
            if (/Firefox/i.test(navigator.userAgent)) {
              const fullScreenChange = (event: any/* TODO: i made this of type any */) => {
      ...
      private _FindIntersections(boxes: THREE.Box3[], position: THREE.Vector3) {
